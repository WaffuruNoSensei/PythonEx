...
while leyendo:
    try:
        ...
        print("\x1b[1;31m", "Introduzca solo valores numéricos enteros\n")

for i in range(1, n+1):
    print ("\x1b[1;33m", i,"  -  ",triangularIterativo(i))
    triangularIterativo(i)


print("No Ecuación Fin")

for i in range(1, n+1):
    print("\x1b[1;33m", i, "  -  ", triangularCalculado(i))
